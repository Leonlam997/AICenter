...
static const char *TAG = "485";


extern "C"
JNIEXPORT jobject JNICALL
Java_com_leon_aicenter_Serial_SerialPort_open(JNIEnv *env, jobject thiz, jstring path,
                                              jint baudrate) {
    int fd;
    speed_t speed;
...
Java_com_leon_aicenter_Serial_SerialPort_close(JNIEnv *env, jobject thiz) {
